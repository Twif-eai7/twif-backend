...
async function sendVendorApplicationCopy({ toEmail, application, signatureName, signedAt, ip }) {
  try {
    ...
    const { data, error } = await resend.emails.send({
      from: RESEND_FROM_EMAIL,
      to: toEmail,
      subject: `Your submitted application & signed NDA - Twif Technologies PTE LTD`,
      html: `
        <div style="font-family:sans-serif;max-width:640px;margin:0 auto;padding:40px 20px;color:#1a1a1a;">
          ...
          <p style="color:#8e8e8e;font-size:13px;margin-top:0;">This is your copy of the details you submitted to Twif Technologies PTE LTD ("Twif") as part of vendor onboarding.</p>
